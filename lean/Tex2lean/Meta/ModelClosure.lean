...
unfold only to constants defined under `Tex2lean/Model/`.
...
/-- All `Tex2lean` constants reachable from a seed, through both types and values. -/
...
/-- Constants not defined under `Tex2lean/Model/`, paired with the module defining them. -/
