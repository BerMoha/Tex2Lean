# Formalization blueprint — proposition

> 2026-09-11T12:20:40.682Z · Claude subscription · claude-opus-5 · `f:\Dossier-recherche\Publications\Publications\P41- B-Fredholm elements in rings and algebras.tex:21`
>
> **This run is still going.** 2 of 4 passes are in this document; the rest have not been decided yet. What is missing below is missing because it has not happened, not because the plan does without it.

## Still to come

- [ ] State what the proof assumes, and ask
- [ ] Design interface, instance, capstone
